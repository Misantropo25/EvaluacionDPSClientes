...
namespace EvaluacionDPS.SomeeReference {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SomeeReference.WebService1Soap")]
    public interface WebService1Soap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string[] EliminarEmpleado(int CustomerID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/EliminarEmpleado", ReplyAction="*")]
        System.Threading.Tasks.Task<string[]> EliminarEmpleadoAsync(int CustomerID);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string[] ActualizarProveedor(int SupplierID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, string HomePage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ActualizarProveedor", ReplyAction="*")]
        System.Threading.Tasks.Task<string[]> ActualizarProveedorAsync(int SupplierID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, string HomePage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/EliminarProveedor", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string[] EliminarProveedor(int SupplierID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/EliminarProveedor", ReplyAction="*")]
        System.Threading.Tasks.Task<string[]> EliminarProveedorAsync(int SupplierID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebService1SoapChannel : EvaluacionDPS.SomeeReference.WebService1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebService1SoapClient : System.ServiceModel.ClientBase<EvaluacionDPS.SomeeReference.WebService1Soap>, EvaluacionDPS.SomeeReference.WebService1Soap {
        ...
        public string[] EliminarEmpleado(int CustomerID) {
            return base.Channel.EliminarEmpleado(CustomerID);
        }
        
        public System.Threading.Tasks.Task<string[]> EliminarEmpleadoAsync(int CustomerID) {
        ...
        public string[] ActualizarProveedor(int SupplierID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, string HomePage) {
        ...
        public System.Threading.Tasks.Task<string[]> ActualizarProveedorAsync(int SupplierID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, string HomePage) {
        ...
        public string[] EliminarProveedor(int SupplierID) {
            return base.Channel.EliminarProveedor(SupplierID);
        }
        
        public System.Threading.Tasks.Task<string[]> EliminarProveedorAsync(int SupplierID) {
